...
@section('modalContent')
        <main role="main">
            <div class="jumbotron bg-white">
                <div class="container">
                    <div class="btn btn-info btn-lg btn-block mt-5">
                        <a href="{{ url('post/create') }}" style="list-style-type:none; color:white">ADD POST</a>
                    </div>
                </div>
            </div>
                ...
                <div class="card mb-2 m-auto" style="width:1100px;">
                    <div class="card-body p-2 p-sm-3" >
                        <div class="media forum-item">
                            <a href="#" data-toggle="collapse" data-target=".forum-content"><img src="/laraveles/forumApp/public/assets/font-awesome-4.7/no-profile-picture-icon.png" class="mr-3 rounded-circle" width="50" alt="User" /></a>
                            ...
                            <form action="{{ url('comment/takeIdpost') }}" method="post">
                                ...
                                <div class="text-muted small text-center align-self-center">
                                    <button class="btn btn-info btn-sm mt-4" type="submit" style="border:0">
                                        Add comment
                                    </button>
                            </div>
                            </form>
                    ...
                    @foreach($post->comments as $comments)
                        <div class="card mb-2 m-auto" style="width:800px;">
                            <div class="card-body p-2 p-sm-3" >
                                <div class="media forum-item">
                                    <a href="#" data-toggle="collapse" data-target=".forum-content"><img src="/laraveles/forumApp/public/assets/font-awesome-4.7/no-profile-picture-icon.png" class="mr-3 rounded-circle" width="50" alt="User" /></a>
                                    <div class="media-body">
